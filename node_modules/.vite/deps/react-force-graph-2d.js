...
import {
  ...
  transform,
  zoom_default
} from "./chunk-IVQQOGC7.js";
import {
  max,
  min,
  ordinal,
  sum
} from "./chunk-VBXNROZT.js";
import {
  require_react
...
function _(l2, t3, u2) {
  var i2, r2, o2, e2 = {};
  for (o2 in t3)
    "key" == o2 ? i2 = t3[o2] : "ref" == o2 ? r2 = t3[o2] : e2[o2] = t3[o2];
...
function m(n2, u2, i2, r2, o2) {
  var e2 = { type: n2, props: u2, key: i2, ref: r2, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: null == o2 ? ++t2 : o2, __i: -1, __u: 0 };
...
function S(n2, l2) {
  ...
  for (var t3; l2 < n2.__k.length; l2++)
    if (null != (t3 = n2.__k[l2]) && null != t3.__e)
      return t3.__e;
...
function $() {
  for (var n2, t3, u2, r2, o2, f2, c3, s2 = 1; i.length; )
    i.length > s2 && i.sort(e), n2 = i.shift(), s2 = i.length, n2.__d && (u2 = void 0, o2 = (r2 = (t3 = n2).__v).__e, f2 = [], c3 = [], t3.__P && ((u2 = w({}, r2)).__v = r2.__v + 1, l.vnode && l.vnode(u2), O(t3.__P, u2, r2, t3.__n, t3.__P.namespaceURI, 32 & r2.__u ? [o2] : null, f2, null == o2 ? S(r2) : o2, !!(32 & r2.__u), c3), u2.__v = r2.__v, u2.__.__k[u2.__i] = u2, z(f2, u2, c3), u2.__e != o2 && C(u2)));
  $.__r = 0;
}
function I(n2, l2, t3, u2, i2, r2, o2, e2, f2, c3, s2) {
  var a3, h2, y3, d2, w2, g2, _2 = u2 && u2.__k || v, m3 = l2.length;
  for (f2 = P(t3, l2, _2, f2, m3), a3 = 0; a3 < m3; a3++)
    null != (y3 = t3.__k[a3]) && (h2 = -1 === y3.__i ? p : _2[y3.__i] || p, y3.__i = a3, g2 = O(n2, y3, h2, i2, r2, o2, e2, f2, c3, s2), d2 = y3.__e, y3.ref && h2.ref != y3.ref && (h2.ref && q(h2.ref, null, y3), s2.push(y3.ref, y3.__c || d2, y3)), null == w2 && null != d2 && (w2 = d2), 4 & y3.__u || h2.__k === y3.__k ? f2 = A(y3, f2, n2) : "function" == typeof y3.type && void 0 !== g2 ? f2 = g2 : d2 && (f2 = d2.nextSibling), y3.__u &= -7);
  return t3.__e = w2, f2;
}
function P(n2, l2, t3, u2, i2) {
  var r2, o2, e2, f2, c3, s2 = t3.length, a3 = s2, h2 = 0;
  for (n2.__k = new Array(i2), r2 = 0; r2 < i2; r2++)
    null != (o2 = l2[r2]) && "boolean" != typeof o2 && "function" != typeof o2 ? (f2 = r2 + h2, (o2 = n2.__k[r2] = "string" == typeof o2 || "number" == typeof o2 || "bigint" == typeof o2 || o2.constructor == String ? m(null, o2, null, null, null) : d(o2) ? m(k, { children: o2 }, null, null, null) : void 0 === o2.constructor && o2.__b > 0 ? m(o2.type, o2.props, o2.key, o2.ref ? o2.ref : null, o2.__v) : o2).__ = n2, o2.__b = n2.__b + 1, e2 = null, -1 !== (c3 = o2.__i = L(o2, t3, f2, a3)) && (a3--, (e2 = t3[c3]) && (e2.__u |= 2)), null == e2 || null === e2.__v ? (-1 == c3 && (i2 > s2 ? h2-- : i2 < s2 && h2++), "function" != typeof o2.type && (o2.__u |= 4)) : c3 != f2 && (c3 == f2 - 1 ? h2-- : c3 == f2 + 1 ? h2++ : (c3 > f2 ? h2-- : h2++, o2.__u |= 4))) : n2.__k[r2] = null;
  if (a3)
    for (r2 = 0; r2 < s2; r2++)
      null != (e2 = t3[r2]) && 0 == (2 & e2.__u) && (e2.__e == u2 && (u2 = S(e2)), B(e2, e2));
  return u2;
}
function A(n2, l2, t3) {
  var u2, i2;
  if ("function" == typeof n2.type) {
    for (u2 = n2.__k, i2 = 0; u2 && i2 < u2.length; i2++)
      u2[i2] && (u2[i2].__ = n2, l2 = A(u2[i2], l2, t3));
    return l2;
  }
  n2.__e != l2 && (l2 && n2.type && !t3.contains(l2) && (l2 = S(n2)), t3.insertBefore(n2.__e, l2 || null), l2 = n2.__e);
  do {
    l2 = l2 && l2.nextSibling;
  } while (null != l2 && 8 == l2.nodeType);
  return l2;
}
function L(n2, l2, t3, u2) {
  var i2, r2, o2 = n2.key, e2 = n2.type, f2 = l2[t3];
  if (null === f2 && null == n2.key || f2 && o2 == f2.key && e2 === f2.type && 0 == (2 & f2.__u))
    return t3;
  if (u2 > (null != f2 && 0 == (2 & f2.__u) ? 1 : 0))
    for (i2 = t3 - 1, r2 = t3 + 1; i2 >= 0 || r2 < l2.length; ) {
      if (i2 >= 0) {
...
function T(n2, l2, t3) {
  "-" == l2[0] ? n2.setProperty(l2, null == t3 ? "" : t3) : n2[l2] = null == t3 ? "" : "number" != typeof t3 || y.test(l2) ? t3 : t3 + "px";
}
function j(n2, l2, t3, u2, i2) {
  var r2;
  n:
    if ("style" == l2)
      if ("string" == typeof t3)
        ...
        if ("string" == typeof u2 && (n2.style.cssText = u2 = ""), u2)
          for (l2 in u2)
            t3 && l2 in t3 || T(n2.style, l2, "");
        if (t3)
          for (l2 in t3)
            u2 && t3[l2] === u2[l2] || T(n2.style, l2, t3[l2]);
      }
    else if ("o" == l2[0] && "n" == l2[1])
      r2 = l2 != (l2 = l2.replace(f, "$1")), l2 = l2.toLowerCase() in n2 || "onFocusOut" == l2 || "onFocusIn" == l2 ? l2.toLowerCase().slice(2) : l2.slice(2), n2.l || (n2.l = {}), n2.l[l2 + r2] = t3, t3 ? u2 ? t3.t = u2.t : (t3.t = c, n2.addEventListener(l2, r2 ? a : s, r2)) : n2.removeEventListener(l2, r2 ? a : s, r2);
    else {
      ...
      "function" == typeof t3 || (null == t3 || false === t3 && "-" != l2[4] ? n2.removeAttribute(l2) : n2.setAttribute(l2, "popover" == l2 && 1 == t3 ? "" : t3));
    }
}
function F(n2) {
  return function(t3) {
    if (this.l) {
      var u2 = this.l[t3.type + n2];
      if (null == t3.u)
        t3.u = c++;
      else if (t3.u < u2.t)
        return;
      return u2(l.event ? l.event(t3) : t3);
    }
  };
}
function O(n2, t3, u2, i2, r2, o2, e2, f2, c3, s2) {
  var a3, h2, p2, v2, y3, _2, m3, b, S2, C2, M2, $2, P2, A2, H, L2, T2, j2 = t3.type;
  if (void 0 !== t3.constructor)
    return null;
  128 & u2.__u && (c3 = !!(32 & u2.__u), o2 = [f2 = t3.__e = u2.__e]), (a3 = l.__b) && a3(t3);
  n:
    if ("function" == typeof j2)
      try {
        if (b = t3.props, S2 = "prototype" in j2 && j2.prototype.render, C2 = (a3 = j2.contextType) && i2[a3.__c], M2 = a3 ? C2 ? C2.props.value : a3.__ : i2, u2.__c ? m3 = (h2 = t3.__c = u2.__c).__ = h2.__E : (S2 ? t3.__c = h2 = new j2(b, M2) : (t3.__c = h2 = new x(b, M2), h2.constructor = j2, h2.render = D), C2 && C2.sub(h2), h2.props = b, h2.state || (h2.state = {}), h2.context = M2, h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), S2 && null == h2.__s && (h2.__s = h2.state), S2 && null != j2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = w({}, h2.__s)), w(h2.__s, j2.getDerivedStateFromProps(b, h2.__s))), v2 = h2.props, y3 = h2.state, h2.__v = t3, p2)
          ...
          if (S2 && null == j2.getDerivedStateFromProps && b !== v2 && null != h2.componentWillReceiveProps && h2.componentWillReceiveProps(b, M2), !h2.__e && (null != h2.shouldComponentUpdate && false === h2.shouldComponentUpdate(b, h2.__s, M2) || t3.__v == u2.__v)) {
            for (t3.__v != u2.__v && (h2.props = b, h2.state = h2.__s, h2.__d = false), t3.__e = u2.__e, t3.__k = u2.__k, t3.__k.some(function(n3) {
              n3 && (n3.__ = t3);
        ...
        if (h2.context = M2, h2.props = b, h2.__P = n2, h2.__e = false, P2 = l.__r, A2 = 0, S2) {
          for (h2.state = h2.__s, h2.__d = false, P2 && P2(t3), a3 = h2.render(h2.props, h2.state, h2.context), H = 0; H < h2._sb.length; H++)
            h2.__h.push(h2._sb[H]);
          h2._sb = [];
        } else
          do {
            h2.__d = false, P2 && P2(t3), a3 = h2.render(h2.props, h2.state, h2.context), h2.state = h2.__s;
          } while (h2.__d && ++A2 < 25);
        h2.state = h2.__s, null != h2.getChildContext && (i2 = w(w({}, i2), h2.getChildContext())), S2 && !p2 && null != h2.getSnapshotBeforeUpdate && (_2 = h2.getSnapshotBeforeUpdate(v2, y3)), L2 = a3, null != a3 && a3.type === k && null == a3.key && (L2 = N(a3.props.children)), f2 = I(n2, d(L2) ? L2 : [L2], t3, u2, i2, r2, o2, e2, f2, c3, s2), h2.base = t3.__e, t3.__u &= -161, h2.__h.length && e2.push(h2), m3 && (h2.__E = h2.__ = null);
      } catch (n3) {
        if (t3.__v = null, c3 || null != o2)
          if (n3.then) {
            for (t3.__u |= c3 ? 160 : 128; f2 && 8 == f2.nodeType && f2.nextSibling; )
              f2 = f2.nextSibling;
            o2[o2.indexOf(f2)] = null, t3.__e = f2;
          } else
            for (T2 = o2.length; T2--; )
              g(o2[T2]);
        else
          t3.__e = u2.__e, t3.__k = u2.__k;
        l.__e(n3, t3, u2);
      }
    else
      null == o2 && t3.__v == u2.__v ? (t3.__k = u2.__k, t3.__e = u2.__e) : f2 = t3.__e = V(u2.__e, t3, u2, i2, r2, o2, e2, c3, s2);
  return (a3 = l.diffed) && a3(t3), 128 & t3.__u ? void 0 : f2;
}
function z(n2, t3, u2) {
...
function V(t3, u2, i2, r2, o2, e2, f2, c3, s2) {
  var a3, h2, v2, y3, w2, _2, m3, b = i2.props, k2 = u2.props, x3 = u2.type;
  if ("svg" == x3 ? o2 = "http://www.w3.org/2000/svg" : "math" == x3 ? o2 = "http://www.w3.org/1998/Math/MathML" : o2 || (o2 = "http://www.w3.org/1999/xhtml"), null != e2) {
    for (a3 = 0; a3 < e2.length; a3++)
      if ((w2 = e2[a3]) && "setAttribute" in w2 == !!x3 && (x3 ? w2.localName == x3 : 3 == w2.nodeType)) {
        t3 = w2, e2[a3] = null;
        break;
      }
  }
  if (null == t3) {
    ...
    t3 = document.createElementNS(o2, x3, k2.is && k2), c3 && (l.__m && l.__m(u2, e2), c3 = false), e2 = null;
  }
  if (null === x3)
    b === k2 || c3 && t3.data === k2 || (t3.data = k2);
  else {
    if (e2 = e2 && n.call(t3.childNodes), b = i2.props || p, !c3 && null != e2)
      for (b = {}, a3 = 0; a3 < t3.attributes.length; a3++)
        b[(w2 = t3.attributes[a3]).name] = w2.value;
    for (a3 in b)
      if (w2 = b[a3], "children" == a3)
        ;
    ...
    for (a3 in k2)
      w2 = k2[a3], "children" == a3 ? y3 = w2 : "dangerouslySetInnerHTML" == a3 ? h2 = w2 : "value" == a3 ? _2 = w2 : "checked" == a3 ? m3 = w2 : c3 && "function" != typeof w2 || b[a3] === w2 || j(t3, a3, w2, b[a3], o2);
    if (h2)
      c3 || v2 && (h2.__html === v2.__html || h2.__html === t3.innerHTML) || (t3.innerHTML = h2.__html), u2.__k = [];
    else if (v2 && (t3.innerHTML = ""), I("template" === u2.type ? t3.content : t3, d(y3) ? y3 : [y3], u2, i2, r2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o2, e2, f2, e2 ? e2[0] : i2.__k && S(i2, 0), c3, s2), null != e2)
      for (a3 = e2.length; a3--; )
        g(e2[a3]);
    c3 || (a3 = "value", "progress" == x3 && null == _2 ? t3.removeAttribute("value") : void 0 !== _2 && (_2 !== t3[a3] || "progress" == x3 && !_2 || "option" == x3 && _2 !== b[a3]) && j(t3, a3, _2, b[a3], o2), a3 = "checked", void 0 !== m3 && m3 !== t3[a3] && j(t3, a3, m3, b[a3], o2));
  }
  return t3;
}
function q(n2, t3, u2) {
  try {
    if ("function" == typeof n2) {
      ...
      i2 && n2.__u(), i2 && null == t3 || (n2.__u = n2(t3));
    } else
      n2.current = t3;
  } catch (n3) {
    l.__e(n3, u2);
...
function B(n2, t3, u2) {
  var i2, r2;
  if (l.unmount && l.unmount(n2), (i2 = n2.ref) && (i2.current && i2.current !== n2.__e || q(i2, null, t3)), null != (i2 = n2.__c)) {
  ...
  if (i2 = n2.__k)
    for (r2 = 0; r2 < i2.length; r2++)
      i2[r2] && B(i2[r2], t3, u2 || "function" != typeof n2.type);
...
function E(t3, u2, i2) {
  var r2, o2, e2, f2;
  u2 == document && (u2 = document.documentElement), l.__ && l.__(t3, u2), o2 = (r2 = "function" == typeof i2) ? null : i2 && i2.__k || u2.__k, e2 = [], f2 = [], O(u2, t3 = (!r2 && i2 || u2).__k = _(k, null, [t3]), o2 || p, p, u2.namespaceURI, !r2 && i2 ? [i2] : o2 ? null : u2.firstChild ? n.call(u2.childNodes) : null, e2, !r2 && i2 ? i2 : o2 ? o2.__e : u2.firstChild, r2, f2), z(e2, t3, f2);
}
function J(l2, t3, u2) {
  var i2, r2, o2, e2, f2 = w({}, l2.props);
  for (o2 in l2.type && l2.type.defaultProps && (e2 = l2.type.defaultProps), t3)
    "key" == o2 ? i2 = t3[o2] : "ref" == o2 ? r2 = t3[o2] : f2[o2] = void 0 === t3[o2] && void 0 !== e2 ? e2[o2] : t3[o2];
  return arguments.length > 2 && (f2.children = arguments.length > 3 ? n.call(arguments, 2) : u2), m(l2.type, f2, i2 || l2.key, r2 || l2.ref, null);
}
n = v.slice, l = { __e: function(n2, l2, t3, u2) {
  ...
  var t3;
  t3 = null != this.__s && this.__s !== this.state ? this.__s : this.__s = w({}, this.state), "function" == typeof n2 && (n2 = n2(w({}, t3), this.props)), n2 && w(t3, n2), null != n2 && this.__v && (l2 && this._sb.push(l2), M(this));
