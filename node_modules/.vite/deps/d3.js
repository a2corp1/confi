  ...
  *neighbors(i) {
  ...
  _project(x06, y06, vx, vy) {
    ...
    if (vy < 0) {
      if (y06 <= this.ymin)
        return null;
      if ((c3 = (this.ymin - y06) / vy) < t)
        y3 = this.ymin, x3 = x06 + (t = c3) * vx;
    } else if (vy > 0) {
      if (y06 >= this.ymax)
        return null;
      if ((c3 = (this.ymax - y06) / vy) < t)
        y3 = this.ymax, x3 = x06 + (t = c3) * vx;
    }
    if (vx > 0) {
      if (x06 >= this.xmax)
        return null;
      if ((c3 = (this.xmax - x06) / vx) < t)
        x3 = this.xmax, y3 = y06 + (t = c3) * vy;
    } else if (vx < 0) {
      if (x06 <= this.xmin)
        return null;
      if ((c3 = (this.xmin - x06) / vx) < t)
        x3 = this.xmin, y3 = y06 + (t = c3) * vy;
    }
    return [x3, y3];
  }
  _edgecode(x3, y3) {
